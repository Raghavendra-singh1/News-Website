...
const fetchbusiness = ({cat}) => {
    const [Data,setData] = useState("");
    const fetchbusiness=async()=>{
        await axios.get(
            "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=22119c0a294141a3adc98f0134fca53d"
